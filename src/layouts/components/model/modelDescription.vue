    ...
    <div class="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
      <div class="lg:pr-4">
        <div class="lg:max-w-lg">
          ...
          <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">模型详情</h1>
          <p class="mt-6 text-xl leading-8 text-gray-700">早产儿视网膜病变 (retinopathy of prematurity，ROP)是一种视网膜毛细血管发育异常化的早产儿眼底疾病，表现为视网膜缺血、新生血管形成和增生性视网膜病变，严重者可以引起视网膜脱离而导致永久性失明。值得注意的是，ROP作为一种儿童主要致盲性及低视力眼病是可避免且可控的，筛查是其早期发现、早期干预和早期矫治的前提和关键措施，对降低儿童致盲率及视力损伤具有重要意义。因此，需要筛选出ROP潜在的风险因素，建立预测模型进而根据这些临床数据预测ROP的早期风险，优化高风险婴儿的识别，同时也能改善筛查时机和效率，避免对低风险婴儿进行不必要的检查。</p>
        </div>
      </div>
    </div>

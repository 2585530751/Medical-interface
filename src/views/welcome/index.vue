...
<template>
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div class="hidden sm:mb-8 sm:flex sm:justify-center">
          <div
            class="backdrop-blur-sm animate__animated animate__rotateInUpLeft relative rounded-full px-3 py-1 text-base leading-6 text-black ring-1 ring-gray-900/10 hover:ring-gray-900/20"
          >
            提前知晓下一轮的更新计划
  ...
  <section class="dark:bg-gray-800 dark:text-gray-100">
    <div class="max-w-xl p-6 py-12 mx-auto space-y-12 lg:px-8 lg:max-w-7xl">
      <div>
        <p class="text-3xl font-bold tracki text-center sm:text-4xl dark:text-gray-50">
          我们的特色
        </p>
        <p class="max-w-3xl text-gray-700 mx-auto mt-4 text-xl text-center dark:text-gray-400">
          针对临床研究人员的一站式医学统计分析平台<br />提供数据治理、数据统计、机器学习分析、智能文章生成服务。
        </p>
      </div>
      <div class="flex-wrap items-center justify-center gap-10 text-center sm:flex">
        <div
          :class="animateCard"
          class="animate__animated w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 dark:bg-gray-800"
        >
          ...
          <p class="py-1 indent-8 text-gray-500 text-md dark:text-gray-300">
  ...
  <section class="dark:bg-gray-700 text-gray-600 body-font py-10 bg-neutral-100">
    <div class="mx-auto max-w-2xl lg:text-center">
      <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-white">我们的模型</p>
      <p class="mt-6 text-lg leading-8 text-gray-600 dark:text-white indent-8 text-center">
    ...
    <div class="container px-5 py-6 mx-auto">
      ...
      >
        <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0 pr-5">
          <h2 class="dark:text-white text-gray-900 text-lg title-font font-medium mb-2 text-center">
            早产儿视网膜病变发病风险预测模型
          </h2>
          <p class="indent-8 dark:text-slate-300 leading-relaxed text-base">
          ...
          <div class="flex justify-end">
            <a class="mt-3 text-indigo-500 items-center"
              >了解更多
              <svg
                fill="none"
                stroke="currentColor"
      ...
      >
        ...
        <div class="pl-2 flex-grow sm:text-left text-center mt-6 sm:mt-0">
          <h2 class="dark:text-white text-gray-900 text-lg title-font font-medium mb-2 text-center">
            新冠肺炎死亡风险评分(CDRS)模型
          </h2>
          <p class="dark:text-slate-300 indent-8 leading-relaxed text-base">
